...
The published runtime is built from `8994963`. Source checks passed 2,777 tests with
...
or Swift pins, including the declared direct-install minimum versions. Requests,
Cryptography and pytest minimums now match the already-audited pins; regenerated
locks retain identical installed versions and package hashes. All 44 real-model E2E cases also passed with Claude CLI, using an
